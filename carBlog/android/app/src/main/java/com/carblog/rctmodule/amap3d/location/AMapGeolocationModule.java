package com.carblog.rctmodule.amap3d.location;
...
public class AMapGeolocationModule extends ReactContextBaseJavaModule implements AMapLocationListener, GeocodeSearch.OnGeocodeSearchListener {
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        eventEmitter.emit("onRegeocodeSearched", toJSON(result));
    }
...
//        AMapLocationClient.setApiKey(key);
    ...
    @ReactMethod
    public void getAddress(ReadableMap params){
        ...
        GeocodeSearch geocoderSearch = new GeocodeSearch(this.reactContext);
    ...
    @ReactMethod
    public void getDistance(ReadableMap location1,ReadableMap location2,Promise promise) {
        LatLng latLng1 = new LatLng(location1.getDouble("latitude"),location1.getDouble("longitude"));
        LatLng latLng2 = new LatLng(location2.getDouble("latitude"),location2.getDouble("longitude"));
    ...
    private ReadableMap toJSON(RegeocodeResult result) {
        if (result == null) {
            return null;
        }
        WritableMap map = Arguments.createMap();
