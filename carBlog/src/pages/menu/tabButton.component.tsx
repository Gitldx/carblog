...
export class TabButton extends React.Component<TabButtonrops> {
    ...
    public render() {
        const iconElement = React.cloneElement(this.props.children, { color: this.props.selected ? ThemeService.getPrimaryColor() : "gray" })
        return (
            <TouchableOpacity
                activeOpacity={0.65}
                {...this.props}
            ...
            >
                <View style={{ alignItems: 'center' }}>
                    ...
                    <Text style={{ color: this.props.selected ? ThemeService.getPrimaryColor() : "gray" }} category="c1">{this.props.lable}</Text>
