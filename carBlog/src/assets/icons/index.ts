...
import { LocalImage } from '../images/type';
...
export const PersonImage: ImageSource = {
  imageSource: require('./eva/person.png'),
}


export const RedGreenImage: ImageSource = {
  imageSource: require('./redgreen.png'),
}

export const HelicopterImage: ImageSource = {
  imageSource: require('./helicopter.png'),
}

export const CarImage: ImageSource = {
  imageSource: require('./car.png'),
}


export const Car2Image: ImageSource = {
  imageSource: require('./car2.png'),
}


export const BlockImage: ImageSource = {
  imageSource: require('./block.png'),
}

export const Road2mage: ImageSource = {
  imageSource: require('./road2.png'),
}
